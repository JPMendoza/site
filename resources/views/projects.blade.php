...
<div class="container">
	...
	<div class="row">
		<div align="center" class=" container col-md-4">
			<a href="{{ asset('/site/public/games/alienabduction/alienabduction.html') }}" >Alien Abduction<br>
				<img src="{{asset('/site/public/img/alien.png')}}" height="150" width="200"></a> <br>
				*Chrome doesn't support unity 
			
		</div>
		<div align="center" class="container col-md-4">
			<a href="{{ asset('/site/public/games/heart4u/heart4u.html') }}"> Heart4u <br> 
				<img src="{{asset('/site/public/img/heart4u.png')}}" height="150" width="200">
			</a>
		</div>
		<div align="center" class="container col-md-4">
			<a href="{{ asset('/site/public/games/cubeclicker/cubeclicker.html') }}" >CubeClicker <br> 
